...
public class Utils extends BasePage {
    ...
    public void dragAndDrop(By by){
        WebElement sourceLocator = driver.findElement(by);
        WebElement targetLocator = driver.findElement(by);
    ...
    public static void explicitwait(By by) { WebDriverWait wait = new WebDriverWait(driver, 50);
    ...
    public static void selectByVisibleText(By element, String name) {new Select(driver.findElement(element)).selectByVisibleText(name);}
